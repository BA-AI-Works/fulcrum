...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    author: {
      name: "Emrah Yayıcı",
      avatar: "/attached_assets/Emrah-yayici_1753967740571.jpeg"
    },
    date: "Feb 28, 2024",
    readTime: "8 min read",
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gray-50 pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-6">
          <Link href="/blog">
            <Button variant="ghost" className="mb-8 text-gray-600 hover:text-fulcrum-red">
              <ChevronLeft className="w-4 h-4 mr-2" />
              Back to Blog
            </Button>
          </Link>
          
          <h1 className="text-4xl md:text-5xl font-bold blog-title mb-8 leading-tight">
            {post.title}
          </h1>
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="flex items-center space-x-6 text-sm text-gray-500">
              <div className="flex items-center space-x-2 px-4 py-2 bg-white rounded-full border">
      ...
      <div className="max-w-4xl mx-auto px-6 pb-16">
        <div 
          className="prose prose-lg max-w-none 
                     prose-headings:font-bold prose-headings:fulcrum-text
      ...
      <div className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold fulcrum-text mb-12 text-center">
            Related Articles
          </h2>
