    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-7xl mx-auto mb-16">
          <div className="border border-gray-200 rounded-3xl p-8 bg-transparent">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              
              {/* Module 1 - White Theme */}
              <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
                <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">
                  Will my organization be able to timely adapt to the major change?
                </h3>
                <h4 className="text-lg font-semibold text-fulcrum-red mb-4">Iterative Approach</h4>
              ...
              <div className="bg-gray-900 rounded-3xl p-8 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h4 className="text-lg font-semibold text-fulcrum-red mb-4">Human-in-the-loop</h4>
